...
class AgentProfileAdmin(admin.ModelAdmin):
    list_display = ('first_name', 'last_name', 'phonenumber', 'agent_type', 'dob', 'province', 'district', 'timestamp', 'updated')
    search_fields = ('first_name', 'last_name', 'phonenumber', 'agent_type__title')
    list_filter = ('timestamp', 'updated', 'agent_type')
    list_per_page = 25

class AccountTypeAdmin(admin.ModelAdmin):
    list_display = ('role', 'manage_all', 'timestamp', 'updated')
    search_fields = ('role',)
    list_filter = ('timestamp', 'updated', 'manage_all')
    list_per_page = 25
